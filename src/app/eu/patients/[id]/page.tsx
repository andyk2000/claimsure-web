...
export default function PatientDetails({ params }: { params: { id: string } }) {
  ...
  const handleViewMedicalHistory = () => {
    router.push(`/eu/patients/${patientId}/medical-history`);
  };

  const handleCreateRequest = () => {
    router.push(`/eu/dashboard/Requests/new-request?patientId=${patientId}`);
  };
    ...
    <div className={styles.pageContainer}>
      <div className={styles.header}>
        ...
        <div className={styles.headerButtons}>
          ...
          <button className={styles.requestButton} onClick={handleCreateRequest}>
            <Icon icon="ph:note-pencil" width="20" height="20" />
            Create Request
          </button>
        </div>
      </div>
